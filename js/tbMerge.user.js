...
;(function() {
    var tbMerge={
        ...
        init:function(){
            ...
            this.isDebug?console.log("被合并吧："+merge+", 保留吧："+keep):null;
            //format check
            for ( var i in formatCheck){
                if(contentHTML.match(formatCheck[i].rule)){
                    ...
                    this.isDebug?console.log(formatCheck[i].name + "通过"):null;
        ...
        isEmpty:function(e){
            ...
            this.isDebug?console.log("copy start"):null;
        }
    };
    tbMerge.init();
    //tbMerge.debug();
