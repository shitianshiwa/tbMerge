    ...
    var tbMerge={
        ...
        init:function(){
            ...
            var regexRule=/将(.*?)吧?合并[至到入][ ]*?(\S+?)[ ]*?吧/,
                isAgreed = /是否.*?达成一致意见[：:].{0,8}是[^否]/,
                isMoved = /是否.*?转移需要保留的内容[：:].{0,8}是/,
                delBar = /吧[、 ,，;和及]/ug,
                delSign = /["“” 【】]+/g;
